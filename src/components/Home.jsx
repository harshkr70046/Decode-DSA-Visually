...
function Home({setAlgorithm}) {
          ...
          <motion.div
            ...
            <div className='relative z-10 w-[full] md:w-1/2 flex flex-col items-center md:items-start justify-center space-y-6'>
              ...
              <motion.div variants={textVariants} className='flex items-center space-x-3 '>
                ...
                <h1 className='text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500'>Decode DSA Visually</h1>
              </motion.div>
            ...
            animate="visible"
                  ...
                  <Rocket size={20} />
                   <NavLink to="/Visualizer" className="text-white">Get Started</NavLink>
                </motion.button>
                <motion.button
                  variants={buttonVariants}
                  whileHover="hover"
          ...
          onMouseMove={handleMouseMove} className='box flex flex-col items-center justify-center h-[50%]  md:w-[100%] md:h-[100%] p-6 md:p-10' style={{ '--x': position.x, '--y': position.y }}>
            ...
            <div className='flex relative z-10 flex-col gap-4 md:gap-10 md:flex-row'>
              <div className='space-y-2 rounded-2xl p-4 pl-5 shadow-lg shadow-blue-300 md:w-[50%]'>
                <div>
                  <h1 className='text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500'><Code size={48} className='text-purple-500 inline-flex' /> Decode DSA Visually</h1>
                ...
                <div className='flex flex-col text-white space-y-5'>
                  ...
                  <div className='flex  space-x-5'>
                   <a href="https://github.com/harshkr70046"> <Github className='bg-gray-800  w-10 h-10 p-2 rounded-md' /> </a>
                    <a href="https://www.linkedin.com/in/me/"> <Linkedin className='bg-gray-800  w-10 h-10 p-2 rounded-md' /> </a>
                    <a href="mailto:kumarharshhk85@gmail.com">
  <Mail className="bg-gray-800 cursor-pointer w-10 h-10 p-2 rounded-md" />
              ...
              <div className=' w-full md:w-1/2 mt-7 md:mt-22'>
                ...
                style={{ border, boxShadow, }} className='relative rounded-2xl'>
                  <div className='relative rounded-2xl overflow-hidden'>
                    <form action="https://formspree.io/f/xvgagadb"
                    method="POST" className='flex flex-col'>
                      <div className='flex flex-col gap-5 justify-center items-center container m-auto w-[90%]  my-5'>
                        ...
                        <textarea name="message" id="" cols="20" rows="5" placeholder='Your Feedback' className='w-full text-gray-500 p-4 outline-none shadow shadow-pink-800 rounded-md'></textarea>
            ...
            <div className='relative z-10 flex flex-col md:flex-row text-sm justify-between items-center mt-10 w-full text-gray-500'>
              <p className='mb-2'>© 2025 Harsh. All rights reserved.</p>
